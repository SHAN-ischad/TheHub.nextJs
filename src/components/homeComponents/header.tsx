    ...
    return (
        ...
        <section className="w-screen mt-[3%] flex justify-center">
            <header className="max-2xl:w-[70%]  fixed z-50 flex justify-center  ">
                <div className="flex items-center justify-baseline p-1 rounded-xl shadow-md bg-white/20 backdrop-blur-md border border-white/10 w-[90%] pr-[20px] max-md:w-1/2 duration-300 max-md:transition-width ">
                    {/* Logo */}
                    ...
                    <nav className="hidden md:flex grow w-full justify-center space-x-8 ">
